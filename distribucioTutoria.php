<?php session_start();
    ...
    $sentencia="select A.nombre, A.apellido1, A.apellido2, A.id_lote, A.id_lote from Alumno A where A.id_tutoria=\"". $_POST['tutoria']."\" and A.banc_llibres=\"1\" order by A.apellido1, A.apellido2, A.nombre";
